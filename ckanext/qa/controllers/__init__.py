...
"""
Common functions for the 'check_link' controller via Pylons or Flask routing.
"""
import json
import mimetypes
import posixpath
...
def check_link():
    ...
    """
    urls = request_helpers.RequestHelper(request).get_query_params('url')
...
def _parse_and_format_date(date_string):
    ...
    """
    dt = ckan_helpers.parse_rfc_2822_date(date_string)
